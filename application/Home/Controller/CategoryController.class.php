	...
	public function index() {
		...
		$prefix= C("DB_PREFIX");	
			...
			$count = M("users_live l")
					->field("l.user_nicename,l.avatar,l.uid,l.stream,l.thumb,l.title,l.city,l.islive")
			...
			$lists=M("users_live l")
					->field("l.user_nicename,l.avatar,l.thumb,l.uid,l.stream,l.title,l.city,l.islive")
					->join("left join {$prefix}users u on u.id=l.uid")
					->where($where)
					->order("l.showid desc")
