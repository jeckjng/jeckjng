...
class MallController extends HomebaseController {
	...
	function buyvip(){
		...
		/* 添加记录 */
        $this->addCoinrecord(array("type"=>'expend',"action"=>'buyvip',"uid"=>$uid,"touid"=>$uid,"giftid"=>$giftid,"giftcount"=>$giftcount,"totalcoin"=>$total,"showid"=>$showid,"addtime"=>$addtime ));
    ...
    function buyliang(){
		...
		/* 添加记录 */
        $this->addCoinrecord(array("type"=>'expend',"action"=>'buyliang',"uid"=>$uid,"touid"=>$uid,"giftid"=>$giftid,"giftcount"=>$giftcount,"totalcoin"=>$total,"showid"=>$showid,"addtime"=>$addtime ));
    ...
    function buycar(){
		...
		/* 添加记录 */
        $this->addCoinrecord(array("type"=>'expend',"action"=>'buycar',"uid"=>$uid,"touid"=>$uid,"giftid"=>$giftid,"giftcount"=>$giftcount,"totalcoin"=>$total,"showid"=>$showid,"addtime"=>$addtime ));
