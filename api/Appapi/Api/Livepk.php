...
class Api_Livepk extends PhalApi_Api {
	...
	public function getLiveList() {
        ...
        $where="uid!={$uid} and (tenant_id='{$tenantId}' or isshare='1')";

		$domain = new Domain_Livepk();
		$list = $domain->getLiveList($uid,$where,$p,$tenantId);
	...
	public function search() {
        ...
        $where="uid!={$uid} and (tenant_id='{$tenantId}' or isshare='1') and (uid='{$key}' or user_nicename like '%{$key}%')";
