//const screenfull = require("../../js/screenfull");
...
var liveType=
{
	...
	ckplayerx:function()
	{
		...
		//var player = new ckplayer(videoObject);
		 var flvUrl=_DATA.live.flvpull;
		//测试直播地址
		//var flvUrl='http://120.25.106.132:8180/live/livestream.flv';
		...
		$(".vjs-fullscreen-control.vjs-control.vjs-button").css("display","none");
		    ...
		    // 手动添加全屏按钮
			$(".vjs-control-bar").append('<button class="vjs-fullscreen-control vjs-control vjs-button" type="button" title="全屏" aria-disabled="false" id="danmu_send_opt" onclick="toggleFullScreen()"><span aria-hidden="true" class="vjs-icon-placeholder"></span></button>');
									...
									<a class="xinxi" onclick="User.popup('+userinfo.id+')">\
										...
										<div class="user_info">\
											<p>\
												...
												<span class="ICON-noble-level ICON-al-'+userinfo.level+'"></span>\
												<span class="ICON-noble-level ICON-nl-'+userinfo.level+'"></span>\
