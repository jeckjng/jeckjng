!
    function(A) {
        ...
        e.m = A,
            ...
            e.t = function(A, t) {
                ...
                if (e.r(n), Object.defineProperty(n, "default", {
                    enumerable: !0,
                    value: A
                }), 2 & t && "string" != typeof A) for (var i in A) e.d(n, i,
                    function(t) {
                        return A[t]
                    }.bind(null, i));
                return n
        ...
        function(A, t, e) {
            ...
            function h(A, t) {
                ...
                var n = c[c.length - 1];
                if ("top" === A.insertAt) n ? n.nextSibling ? e.insertBefore(t, n.nextSibling) : e.appendChild(t) : e.insertBefore(t, e.firstChild),
                    c.push(t);
                ...
                i = function() {
                    ...
                    return A.prototype.willCollide = function(A, t) {
                        ...
                        A.prototype.pathCheck = function(A, t, e) {
                            for (var n = A + t.height,
                                     i = t.right,
                                     o = 0; o < e.length; o++) if (! (e[o].y > n || e[o].bottom < A)) {
                        ...
                        A.prototype.assign = function(A, t) {
                            ...
                            var e = this._pools[t];
                            if (0 === e.length) return A.cindex = t,
                                0;
                            if (this.pathCheck(0, A, e)) return A.cindex = t,
                                0;
                            for (var n = 0,
                                     i = 0; i < e.length && !((n = e[i].bottom + this.avoid) + A.height > this._height); i++) if (this.pathCheck(n, A, e)) return A.cindex = t,
                                n;
                            return this.assign(A, t + 1)
                        },
                        A.prototype.add = function(A) {
                            A.height > this._height ? (A.cindex = -2, A.y = 0) : (A.y = this.assign(A, 0), e.binsert(this._pools[A.cindex], A,
                                function(A, t) {
                ...
                o = function(A) {
                    ...
                    return n(t, A),
                        ...
                        t.prototype.pathCheck = function(A, t, e) {
                            for (var n = A + t.height,
                                     i = 0; i < e.length; i++) if (! (e[i].y > n || e[i].bottom < A)) return ! 1;
                            return ! 0
                        },
                        t
                } (i),
                r = (n = this && this.__extends ||
                    function(A, t) {
                        for (var e in t) t.hasOwnProperty(e) && (A[e] = t[e]);
                        function n() {
                            this.constructor = A
                    ...
                    function() {
                        function A(t, e) {
                            ...
                            e.hasOwnProperty("position") && "relative" === e.position && (this.absolute = !1, this.mode < 7 && console.warn("Using relative position for CSA comment."))
                        }
     ...
     */
            !
                function() {
                    var A = function(A, t) {
                        for (var e = Math.PI / 180,
                                 n = A * e,
                                 i = t * e,
                                 o = Math.cos,
                                 r = Math.sin,
                                 a = [o(n) * o(i), o(n) * r(i), r(n), 0, -r(i), o(i), 0, 0, -r(n) * o(i), -r(n) * r(i), o(n), 0, 0, 0, 0, 1], l = 0; l < a.length; l++) Math.abs(a[l]) < 1e-6 && (a[l] = 0);
                    ...
                    t.prototype.stop = function() {
                        ...
                        t.prototype.seek = function(A) {
                            this.position = e.bsearch(this.timeline, A,
                                function(A, t) {
                        ...
                        t.prototype.send = function(t) {
                            if (8 !== t.mode) {
                                if (null == this.filter || null != (t = this.filter.doModify(t))) {
                                    ...
                                    e.y = e.y,
                                        this.dispatchEvent("enterComment", e),
                                        this.runline.push(e)
                                }
        ...
        function(A, t, e) { (A.exports = e(0)(!1)).push([A.i, ".bullet-screen {\n  position: absolute;\n  white-space: nowrap;\n  animation: bullet 10s linear infinite; }\n\n@keyframes bullet {\n  from {\n    left: 100%; }\n  to {\n    left: 0;\n    transform: translateX(-100%); } }\n", ""])
        },
        function(A, t, e) {
            var n = e(38);
            "string" == typeof n && (n = [[A.i, n, ""]]);
        ...
        function(A, t, e) { (A.exports = e(0)(!1)).push([A.i, ".pause-ad {\n  width: 60%;\n  height: 50%;\n  background: #000;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  position: absolute;\n  display: none; }\n  .pause-ad .btn-close {\n    position: absolute;\n    top: 5px;\n    right: 5px;\n    background-color: #333;\n    width: 2px;\n    height: 15px;\n    padding: 2px 8px;\n    cursor: pointer; }\n    .pause-ad .btn-close i {\n      background-color: #fff;\n      width: 2px;\n      height: 15px;\n      position: absolute; }\n    .pause-ad .btn-close .split-left {\n      transform: rotate(-45deg); }\n    .pause-ad .btn-close .split-right {\n      transform: rotate(45deg); }\n  .pause-ad .ad-text {\n    position: absolute;\n    left: 5px;\n    top: 5px;\n    background-color: #333;\n    color: #fff;\n    padding: 3px 5px;\n    font-size: 14px; }\n  .pause-ad .ad-content {\n    width: 100%;\n    height: 100%;\n    display: flex;\n    align-items: center;\n    justify-content: center; }\n    .pause-ad .ad-content img {\n      max-width: 100%;\n      max-height: 100%; }\n", ""])
        },
        function(A, t, e) {
            var n = e(42);
            "string" == typeof n && (n = [[A.i, n, ""]]);
        ...
        function(A, t, e) { (A.exports = e(0)(!1)).push([A.i, ".player-hidden {\n  display: none !important; }\n\n.quality-components {\n  float: right;\n  color: #fff;\n  height: 35px;\n  position: relative;\n  box-sizing: border-box;\n  margin-top: 4px; }\n\n.current-quality {\n  display: flex;\n  height: 100%;\n  align-items: center;\n  justify-content: center;\n  width: 70px;\n  cursor: pointer; }\n\n.quality-list {\n  position: absolute;\n  bottom: 46px;\n  display: none;\n  padding: 0;\n  margin: 0;\n  list-style: none; }\n  .quality-list li {\n    text-align: center;\n    width: 70px;\n    line-height: 30px;\n    background-color: rgba(0, 0, 0, 0.6);\n    cursor: pointer; }\n    .quality-list li.current {\n      color: #00c1de; }\n    .quality-list li + li {\n      border-top: 1px solid rgba(78, 78, 78, 0.3); }\n    .quality-list li:hover {\n      background-color: rgba(0, 0, 0, 0.5); }\n\n.quality-modal {\n  position: absolute;\n  bottom: 20%;\n  left: 5%;\n  background-color: rgba(0, 0, 0, 0.6);\n  border-radius: 5px;\n  color: #fff;\n  padding: 10px 15px;\n  font-size: 14px;\n  display: none; }\n  .quality-modal span.current-quality-tag {\n    color: #00c1de; }\n\n@media (max-width: 768px) {\n  .current-quality {\n    width: 40px; }\n  .quality-list li {\n    width: 45px; } }\n", ""])
        },
        function(A, t, e) {
            var n = e(53);
            "string" == typeof n && (n = [[A.i, n, ""]]);
        ...
        function(A, t, e) { (A.exports = e(0)(!1)).push([A.i, ".start-ad {\n  width: 100%;\n  height: 100%;\n  box-sizing: border-box;\n  background-color: #000;\n  position: absolute;\n  z-index: 9999; }\n  .start-ad .tip {\n    position: absolute;\n    right: 5px;\n    top: 5px;\n    background-color: #333;\n    color: #fff;\n    font-size: 14px;\n    text-align: center;\n    padding: 3px 7px; }\n    .start-ad .tip i {\n      font-style: normal; }\n  .start-ad a {\n    width: 100%;\n    height: 100%;\n    display: inline-block;\n    text-align: center;\n    display: flex;\n    align-items: center;\n    justify-content: center; }\n    .start-ad a img {\n      max-width: 100%;\n      max-height: 100%; }\n", ""])
        },
        function(A, t, e) {
            var n = e(59);
            "string" == typeof n && (n = [[A.i, n, ""]]);
        ...
        function(A, t, e) {
            ...
            var u = function() {
                ...
                p = function() {
                    ...
                    return u(A, [{
                        ...
                        value: function(A, t) {
                            ...
                            } else if (null !== this.sendEl) if (d(this.sendEl)) this.sendEl.appendChild(this.danmuInput);
                            else {
                            ...
                            r ? A.insertBefore(this.html, r) : A.appendChild(this.html),
                                this.CM = new CommentManager(this.html.querySelector(".danmu")),
                                this.CM.init(),
                    ...
                    },
                        {
                            ...
                            value: function(A, t) {
                                var e = this,
                                    ...
                                    o = this.getTime(i);
                                if (null !== (o = o ? parseInt(o) : 0) && 0 !== o && !this.hasMemoryDisplay) if (this.hasMemoryDisplay = !0, this.autoPlay) A.seek(o),
                        ...
                        },
                        {
                            ...
                            value: function(A) {
                                ...
                                this.html.querySelector(".quality-list").innerHTML = i.join(""),
                                    this.definition,
                                0 == this.hasCreated && this.definition && (n.querySelector('li[data-def="' + this.definition + '"]').className = "current"),
                                    this.hasCreated = !0;
                                var o = null;
                                e.onclick = function() {
                            ...
                            value: function(A, t) {
                                ...
                                this.html.querySelector(".icon-player-switch").onclick = function() {
                                    ...
                                    e.onclick = function(t) {
                                        var e = t.target;
                                        if ("counterclockwise" !== e.dataset.id) if ("clockwise" !== e.dataset.id) if (e.className.match("active")) A.cancelImage(),
                                            e.className = "mirror-item";
                                        else {
                                            ...
                                            A.setImage(i),
                                                e.className = "mirror-item active"
                                        } else {
                                            var o = A.getRotate();
                                            A.setRotate(o + 45)
                                        } else {
                ...
                sA = "function" == typeof Symbol && "symbol" === lA(Symbol.iterator) ?
                    function(A) {
            ...
            function MA() {
                dA.landscape() ? (vA("portrait"), fA("landscape"), xA("landscape")) : (vA("landscape"), fA("portrait"), xA("portrait")),
                    wA()
            }
            function xA(A) {
            ...
            Object.prototype.hasOwnProperty.call(window, "onorientationchange") && (bA = "orientationchange"),
                window.addEventListener ? window.addEventListener(bA, MA, !1) : window.attachEvent ? window.attachEvent(bA, MA) : window[bA] = MA,
                MA(),
                dA.type = NA(["mobile", "tablet", "desktop"]),
                dA.os = NA(["ios", "iphone", "ipad", "ipod", "android", "blackberry", "windows", "fxos", "meego", "television"]),
                wA();
            var IA = dA,
                TA = function() {
                    function A(A, t) {
                ...
                OA = function() {
                    ...
                    return zA(A, [{
                        ...
                        value: function(A, t) {
                            ...
                            0 == this.hasCreated && this.definition && (o.querySelector('li[data-def="' + this.definition + '"]').className = "current"),
                                this.hasCreated = !0;
                            var r = null;
                            i.onclick = function() {
                                ...
                                o.onmouseleave = function() {
                                    o.style.display = "none",
                                        e.modalHtml.style.display = "none"
                                },
                    ...
                    return JA(A, [{
                        ...
                        },
                        {
                            ...
                            value: function(A, t) {
                                ...
                                this.indexVideo = Number(this.indexVideo);
                                var n = this;
                                this.html.querySelector("#many-video-ad-content" + this.indexVideo).addEventListener("ended",
                                    function(t) {
                        ...
                        },
                        {
                            ...
                            value: function(A) {
                                ...
                                this.adInterval = setInterval(function() {
                                        ...
                                        e.innerText = A,
                                        1 == A && clearInterval(t.adInterval)
                                    },
                                    1e3)
                            }
                        },
                        ...
                        },
                        {
                            key: "playNext",
                            value: function(A) {
                                if (A.indexVideo >= A.adVideoSource.length) return A.html.parentNode.removeChild(A.html),
                                    -1;
                                this.indexVideo = Number(this.indexVideo),
                                null != document.getElementById("many-video-ad-content" + this.indexVideo) && document.getElementById("many-video-ad-content" + this.indexVideo).remove();
                        ...
                        },
                        {
                            ...
                            value: function() {
                                ...
                                this.adInterval = setInterval(function() {
                                        ...
                                        t.innerText = n,
                                        1 == n && clearInterval(A.adInterval)
                                    },
                                    1e3)
                            }
                        },
