...
class UsersModel extends CommonModel
{
	...
	protected $_validate = array(
		...
		array(array('user_login','tenant_id'),'','用户名已经存在！',0,'unique',CommonModel:: MODEL_BOTH ), // 验证user_login字段是否唯一
		array(array('user_email','tenant_id'),'','邮箱帐号已经存在！',2,'unique',CommonModel:: MODEL_BOTH ), // 验证user_email字段是否唯一
