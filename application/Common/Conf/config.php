...
$configs= array(
        ...
        'MODULE_ALLOW_LIST'  => array('Admin','Portal','Asset','Api','Rpc','User','Wx','Comment','Qiushi','Tpl','Topic','Install','Bug','Better','Pay','Cas','Home','Appapi'), //允许访问模块列表
        ...
        'JS_VERSION'            => 1.0008, // js 版本设置
        'CSS_VERSION'           => 1.0006, // js 版本设置

        'PAGE_LISTROWS' => 20,//后台默认分页数
);
