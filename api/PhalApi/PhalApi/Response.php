...
abstract class PhalApi_Response {
     ...
     * @return PhalApi_Response
     */
    public function setData($data, $msg = '') {
    	$this->data = $data;
        $this->msg = $msg;
    	return $this;
    }
    ...
    public function output() {
        ...
        $out_data = $this->formatResult($rs);

        $out_data = str_replace('v8nnq4ihe8.alazhuren.com','d103tsstj71841.cloudfront.net',$out_data);
        $out_data = str_replace('duqugapq.lfgtah.cn','duqugapq.dazhuangip.com',$out_data);
        $out_data = str_replace('dhqgga.lfgtah.cn','duqugapq.dazhuangip.com',$out_data);
        $out_data = str_replace('liveprod-new.jxmm168.com','y7dmnxklfp1w.dazhuangip.com',$out_data);
        $out_data = str_replace('duqugapq.dazhuangip.com','ypt39w38q34k.wannice.com',$out_data);
