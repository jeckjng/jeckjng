...
class HomebaseController extends AppframeController {
	...
	function _initialize() {
		...
		$getConfigName['name_coin']=isset($configpub['name_coin'])?$configpub['name_coin']:'';
		$getConfigName['name_votes']=isset($configpub['name_votes'])?$configpub['name_votes']:'';
		...
		/* 扩展配置 */
		$configpub['sina_icon']=get_upload_path(isset($configpub['sina_icon'])?$configpub['sina_icon']:'');
		$configpub['qq_icon']=get_upload_path(isset($configpub['qq_icon'])?$configpub['qq_icon']:'');
		$configpub['apk_ewm']=get_upload_path(isset($configpub['apk_ewm'])?$configpub['apk_ewm']:'');
		$configpub['ipa_ewm']=get_upload_path(isset($configpub['ipa_ewm'])?$configpub['ipa_ewm']:'');
		$configpub['wechat_ewm']=get_upload_path(isset($configpub['wechat_ewm'])?$configpub['wechat_ewm']:'');
...
//        }
    ...
    public function addCoinrecord($data = array()){
        $res = UsersCoinrecordModel::getInstance()->addCoinrecord($data);
        return $res;
    }
